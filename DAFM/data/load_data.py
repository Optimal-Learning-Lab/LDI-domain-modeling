...
def preprocessing(dataset_path, columns_list):
    ...
    data['correct']=np.where(data['Outcome'].str.lower()=="correct",1,(np.where(data['Outcome'].str.lower()=="incorrect",0,-1)))

    #columns_list[columns_list.index('Outcome')]='CF (Ansbin)'
    print(columns_list)
...
def train_test_user(data, args):
    ...
    train_test_path = args.source_path + "datasets/" + args.dataset[0]+ "/Users/"
