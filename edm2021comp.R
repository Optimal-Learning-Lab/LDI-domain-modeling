...
mean(y1[grepl("logfailAC",rownames(y1)),])

mean(y2[grepl("logsucAC",rownames(y1)),])-
     mean(y2[grepl("logfailAC",rownames(y1)),])
...
barplot(as.matrix(myx),col=brewer.pal(9, "RdPu"),  legend = rownames(myx), beside = TRUE,horiz=TRUE,
        ylab = "Components",xlim=c(0,0.02),main="Physics Data (Covariance Clustering)",xlab="Proportion R-squared Gain")
...
myx[,1]<-NULL
barplot(as.matrix(myx),col=brewer.pal(9, "RdPu"),  legend = rownames(myx), beside = TRUE,horiz=TRUE,
        ylab = "Components",xlim=c(0,0.02),main="Cloze Data (Covariance Clustering)",xlab="Proportion R-squared Gain")
...
myx[,1]<-NULL
barplot(as.matrix(myx),col=brewer.pal(9, "RdPu"),  legend = rownames(myx), beside = TRUE,horiz=TRUE,
        ylab = "Components",xlim=c(0,0.02),main="Physics Data (SPARFA)",xlab="Proportion R-squared Gain")
